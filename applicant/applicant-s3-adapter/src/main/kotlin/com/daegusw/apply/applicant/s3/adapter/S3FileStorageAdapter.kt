...
import com.daegusw.apply.applicant.s3.adapter.common.ApplicantAwsS3Properties
...
class S3FileStorageAdapter(
    private val awsProperties: ApplicantAwsS3Properties,
    @Qualifier("applicantS3Client")
